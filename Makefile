...
CARGO_TEST = RUSTFLAGS="-L ./crates/pos-compute/resources" cargo test rig --all-features --manifest-path ./crates/pos-service/Cargo.toml -- --nocapture --show-output --test-threads=1
